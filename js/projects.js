var projectData = [
    ...
    {'title': "Bon Voyage", 'projectImg':'images/bonvoyage.png', 'description': 'Bon Voyage is a web application for booking travel packages designed for an simplified mobile user experience.', 'learnMore': 'projects_bonvoyage.html', 'sourceCode':'https://github.com/ChristinaMak/Bon-Voyage', 'demo':'https://christinamak.github.io/Bon-Voyage/', 'index': 1},
...
$(document).ready(function() {
    ...
    for (var i = 0; i < projectData.length; i++) {
        ...
        if (projectData[i]['sourceCode'] != "" && projectData[i]['sourceCode'] != null) {
            ($("#cards" + i)).append('<a href="' + projectData[i]['sourceCode'] + '"class="btn btn-primary">Code</a>')
        }
    }
})
